...
static inline uint_fast32_t mod_mac2(uint_fast32_t sum, uint_fast32_t a,
  ...
  assert(c <= 0x7FFFFFFE);
  assert(d <= 0x7FFFFFFE);
  return (uint_fast32_t)(((uint_fast64_t)a * b + (uint_fast64_t)c * d + sum) %
                         0x7FFFFFFF);
}
...
static inline uint_fast32_t mod_mac3(uint_fast32_t sum, uint_fast32_t a,
  ...
  assert(e <= 0x7FFFFFFE);
  assert(f <= 0x7FFFFFFE);
  return (uint_fast32_t)(((uint_fast64_t)a * b + (uint_fast64_t)c * d +
                          (uint_fast64_t)e * f + sum) %
                         0x7FFFFFFF);
}
...
static inline uint_fast32_t mod_mac4(uint_fast32_t sum, uint_fast32_t a,
  ...
  assert(h <= 0x7FFFFFFE);
  return (uint_fast32_t)(((uint_fast64_t)a * b + (uint_fast64_t)c * d +
                          (uint_fast64_t)e * f + (uint_fast64_t)g * h + sum) %
                         0x7FFFFFFF);
}
